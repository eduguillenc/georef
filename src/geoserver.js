...
L.g.wms = function (baseLayerUrl, options) {
var req = new L.g(baseLayerUrl, options);
return req.wms();
};
L.g.wfs = function (baseLayerUrl, options) {
var req = new L.g(baseLayerUrl, options);
return req.wfs();
};
L.g.legend = function (baseLayerUrl, options) {
var req = new L.g(baseLayerUrl, options);
return req.legend();
};
L.g.wmsImage = function (baseLayerUrl, options) {
var req = new L.g(baseLayerUrl, options);
return req.wmsImage();
};